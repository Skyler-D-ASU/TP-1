...
public class EmailAddressRecognizer {
	...
	private static boolean running;						// The flag that specifies if the FSM is 
														// running
	private static int charNdxReturn;
	...
	public static String checkEmailAddress(String input) {
		...
		case 0:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Character " + emailAddressIndexofError + " May only be alphanumberic.\n";
		...
		case 1:
			...
			// State 0 is not a final state, so we can return a very specific error message
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Character " + emailAddressIndexofError + " May only be alphanumberic, @, or a period.\n";
			return emailAddressErrorMessage;
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "Character " + emailAddressIndexofError + "  must be followed with an Alphanumeric character.\n";
			return emailAddressErrorMessage;
