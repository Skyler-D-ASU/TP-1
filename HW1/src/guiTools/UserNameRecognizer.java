...
public class UserNameRecognizer {
	...
	private static boolean tooShort = true;					// The flag that specifies the character set is too short
	private static boolean tooLong;						// The flag that specifies the character set is too long
	private static boolean improperCharacterType;
	private static int userNameSize = 0;			// A numeric value may not exceed 32 characters or be less than 4
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// . -> State 2
				else if (currentChar == '.' || 	 // Checks for .
		...
		case 0:
			...
			return "A UserName must start with A-Z or a-z\n";
		...
		case 1:
			...
			if (improperCharacterType) {
				// UserName is too long
				userNameRecognizerErrorMessage += 
					"This type of character in not valid.\n";
				return "This username includes an improper character type.";
			}
			else if (tooLong) {
				// UserName is too long
				userNameRecognizerErrorMessage += 
					"A UserName must have no more than 32 characters.\n";
				return "A UserName must have no more than 32 characters.";
			}
			else if (tooShort) {
		...
		case 2:
			...
			return "A UserName character after a period, dash, underscore, or ampersand must be A-Z, a-z, 0-9.\n";
